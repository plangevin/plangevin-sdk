...
public class PostgreSQLInt4Array implements java.sql.Array {
	...
	public PostgreSQLInt4Array(Integer[] intArray) {
	 ...
	 */
	public static String intArrayToPostgreSQLInt4ArrayString(Integer[] a) {
		if ( a == null ) {
			return null;
		}
	...
	public static String intArrayToCommaSeparatedString(Integer[] a) {
		if ( a == null ) {
			return null;
		}
		final int al = a.length;
