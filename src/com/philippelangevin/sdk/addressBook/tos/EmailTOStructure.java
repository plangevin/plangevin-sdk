...
public class EmailTOStructure implements TransferableObjectStructureIF {
	...
	public static final class ColumnNames extends TransferableObjectInfoContainer {
		...
		public static final ColumnInfo<String> email = createColumn(new StringMetaData( false, 150 ));
