...
public class StringUtil {
	 ...
	 * @param chaine1
	 * @param chaine2
	 * @return Le nb de diff�rence entre les 2 chaines (0 pour des chaines parfaitement identiques)
	 */
	 ...
	 * Example: StringUtil.unAccent("H�h� ��") will return "Hehe Ce".
	 * 
	 * @param o
	 * @return
	 */
